...
strata_times = {}  # chiave: qlen, valore: lista dei tempi di attraversamento dei pacchetti arrivati quando la coda aveva qlen lunghezza
strata_counts = {} # chiave: qlen, valore: conteggio pacchetti arrivati quando la coda aveva qlen lunghezza
