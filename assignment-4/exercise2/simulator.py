...
class MM1QueueSimulator:
    ...
    def plot_cumulative_packets_in_system(self, warmup_time=0.0):
        ...
        plt.plot(cumulative_time, cumulative_avg_packets, label=f"Empirical {self.average_packets_in_system():.3f} ({warmup_time} warmup)" if warmup_time > 0 else f"Empirical  {self.average_packets_in_system():.3f} (no warmup)")
    ...
    def plot_together(self, warmup_time=0.0):
        ...
        ax2.plot(cumulative_time, cumulative_avg_packets, label=f"Empirical {empirical_value:.3f} ({warmup_time} warmup)" if warmup_time > 0 else f"Empirical  {empirical_value:.3f} (no warmup)")
